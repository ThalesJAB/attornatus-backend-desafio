...
//        		, endereco6, endereco7, endereco8, endereco9, endereco10));
		...
		Pessoa pessoa1 = new Pessoa(null, "Maria", LocalDate.of(1985, 5, 15),
				Arrays.asList(endereco1, endereco2, endereco3));
		Pessoa pessoa2 = new Pessoa(null, "João", LocalDate.of(1990, 1, 1),
				Arrays.asList(endereco4, endereco5, endereco6));
