...
class ResourceExceptionHandlerTest {
	...
	private static final String MENSAGEM_DE_ERRO_2 = "Mensagem de erro de validação de teste 2";
	private static final String MENSAGEM_DE_ERRO_1 = "Mensagem de erro de validação de teste 1";
	...
	@Test
	void whenHandleMethodArgumentNotValidExceptionThenReturnValidationErrors()
			throws NoSuchMethodException, SecurityException {

		List<FieldError> errors = new ArrayList<>();
		FieldError erro1 = new FieldError("testObject", TEST_FIELD1, MENSAGEM_DE_ERRO_1);
		FieldError erro2 = new FieldError("testObject", TEST_FIELD2, MENSAGEM_DE_ERRO_2);
		...
		Method method = ResourceExceptionHandler.class.getMethod("validationError",
				MethodArgumentNotValidException.class, HttpServletRequest.class);
		...
		assertEquals(MENSAGEM_DE_ERRO_1, validationError.getErros().get(0).getMessage());
		assertEquals(TEST_FIELD2, validationError.getErros().get(1).getFieldName());
		assertEquals(MENSAGEM_DE_ERRO_2, validationError.getErros().get(1).getMessage());
